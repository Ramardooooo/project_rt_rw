...
<div class="ml-64 min-h-screen flex items-center justify-center p-6">
    <div class="max-w-lg w-full animate-in">
        ...
        <!-- Card Header Premium - Tema Hijau (tanpa icon) -->
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden card-shadow">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-5">
                <div>
                    <h2 class="text-xl font-bold text-white tracking-tight">Tambah RT</h2>
                    <p class="text-xs text-emerald-100 mt-0.5">Tambahkan data Rukun Tetangga baru</p>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_rt" placeholder="Contoh: RT 01"
                            required
                        ...
                        <p class="text-xs text-gray-400 mt-1">* Nama RT akan digunakan untuk identifikasi</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="rw_id" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-emerald-400 form-input-focus transition-all bg-gray-50/50 cursor-pointer">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="ketua_rt_id" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-emerald-400 form-input-focus transition-all bg-gray-50/50 cursor-pointer">
                    ...
                    <div class="flex gap-3 pt-2">
                        <button type="submit" name="add_rt"
        ...
        <p class="text-center text-xs text-gray-400 mt-6">
            <i class="fas fa-shield-alt mr-1"></i> Data RT akan tercatat dalam sistem
        </p>
    </div>
</div>
</body>
