...
<header class="bg-white shadow-md border-b border-gray-200 sticky top-0 z-50">
    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <a href="/" class="flex items-center space-x-3 hover:opacity-90 transition-all duration-300 cursor-pointer group">
            <img src="LOGO/WhatsApp Image 2026-04-28 at 12.49.16 (1).jpeg" alt="Lurahgo Logo" class="h-12 w-auto rounded-lg shadow-sm group-hover:scale-105 group-hover:shadow-md transition-all duration-300 object-contain bg-white">
            <div>
