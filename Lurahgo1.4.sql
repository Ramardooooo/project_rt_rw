...
-- Dumping structure for table rt_testing.visitors
...
-- Dumping structure for table rt_testing.visitor_config
CREATE TABLE IF NOT EXISTS `visitor_config` (
  `id` int NOT NULL DEFAULT '1',
  `track_localhost` tinyint(1) DEFAULT '0',
  `track_logged_users` tinyint(1) DEFAULT '0',
  `max_logs_per_ip` int DEFAULT '100',
